      ...
      <div className="flex flex-col lg:flex-row justify-between items-start gap-6">
        <div className="flex items-start gap-6">
          <Avatar className="h-24 w-24">
            <AvatarImage
              src={`/abstract-geometric-shapes.png?height=96&width=96&query=${player?.firstName || ''}+${player?.lastName || ''}`}
            />
            <AvatarFallback className="text-2xl">{getInitials(player?.firstName, player?.lastName)}</AvatarFallback>
          </Avatar>
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-3">
              <HandicapBadge handicap={player?.handicap || 0} />
            </div>
          </div>
        </div>
          ...
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xl font-bold">{(player?.handicap || 0).toFixed(1)}</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xl font-bold">{player?.membershipNumber || "N/A"}</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xl font-bold">{calculateAge(player?.dateOfBirth) || "N/A"}</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div>
              ...
              <p className="text-2xl font-bold">{(player?.handicap || 0).toFixed(1)}</p>
            </div>
            <div>
              <p className="text-sm text-muted-foreground">Preferred Category</p>
              <p className="font-medium capitalize">{player?.gender === 'Female' ? "Ladies" : "Open"}</p>
            </div>
          </CardContent>
        </Card>
      </div>

...
import { MatchPlayBracket } from "@/components/tournaments/MatchPlayBracket"
    ...
    <MainLayout>
      <div className="space-y-6">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start gap-4">
          <div>
            <h1 className="text-3xl font-bold">Match Play Bracket</h1>
        ...
        {/* Match Play Bracket Component */}
        <MatchPlayBracket tournamentId={tournamentId} canEdit={canEdit} />
      </div>
    </MainLayout>
  )
}

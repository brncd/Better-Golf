...
function tsEnumMember(value, metadata = {}) {
  ...
  if (trimmedDescription === void 0 || trimmedDescription === null || trimmedDescription === "") {
    return member;
  }
  return ts__default.addSyntheticLeadingComment(member, ts__default.SyntaxKind.SingleLineCommentTrivia, ` ${trimmedDescription}`, true);
}
